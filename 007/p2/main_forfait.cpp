...
bool isSolvable(vector<long long int> eq, long long int res)
{
    ...
    generateCombinations(ops, "+*|", eq.size());
...
{
    //creo tutte le combinazioni possibili della stringa chars, ma l'ultimo carattere può comparire
    //una sola volta all'interno della stringa
    //ma non c'ho voglia.
